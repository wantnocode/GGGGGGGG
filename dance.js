  ...
  function loadCss() {
    ...
    myCss.setAttribute('href', 'https://loli-rbq.top/carnival/css/high.css'); 
  ...
  function setBgm() {
    ...
    e.src = 'https://loli-rbq.top/carnival/audio/Martin%20Jensen%20-%20Fox%20(Loop%20Remix).mp3'; 
    e.loop = false;
    e.addEventListener(
      'canplay',
      function () {
